  ...
  <section className="py-12 sm:py-20 px-4 sm:px-6 bg-background">
    <div className="container mx-auto max-w-4xl">
      <div className="prose prose-lg max-w-none text-muted-foreground">
        ...
        <p className="mb-4 leading-relaxed">
          Мы изготавливаем стенды любой сложности и назначения: информационные стенды для школ и офисов, навигационные системы для торговых центров и госучреждений, стенды с подсветкой для выставок, акриловые конструкции премиум-класса, фотозоны для мероприятий и интерьерные вывески.
        </p>
        <p className="mb-4 leading-relaxed">
          Работаем как с готовыми типовыми решениями, так и разрабатываем уникальный дизайн под ваши задачи. Наши дизайнеры создадут макет с учётом ваших требований, фирменного стиля и специфики помещения. Используем современные материалы: ПВХ, акрил, алюминиевый композит, металл, дерево. Применяем УФ-печать, аппликацию плёнкой, гравировку и другие технологии декорирования.
        </p>
