  ...
  const products: Product[] = [
    {
      ...
      fullDescription: {
        intro: 'Навигация — это про удобство и безопасность. Грамотные указатели сокращают время поиска кабинетов и служб, разгружают стойки информации и создают благоприятное впечатление.',
        tasks: [
          'Люди быстрее ориентируются в зданиях и не потеряются',
    ...
    },
    {
      ...
      fullDescription: {
        ...
        tasks: [
          ...
          'Лёгко протирать, не выгорает на солнце',
    ...
    },
    {
      ...
      fullDescription: {
        intro: 'Подвесные системы — панно крепятся на тросах с потолка. Стены остаются целыми, а картинки можно менять хоть каждую неделю.',
        tasks: [
          'Меняем выставки без повреждений стен',
          'Смотрится лёгко и воздушно благодаря тонким тросам',
