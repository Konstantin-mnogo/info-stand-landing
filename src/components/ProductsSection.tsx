  ...
  const products: Product[] = [
    {
      ...
      fullDescription: {
        ...
        materials: 'Используем алюминий, пластик, акрил и нержавейку. Печатаем на УФ-принтере, делаем гравировку. Можно быстро менять информацию через специальные карманы.',
        options: [
