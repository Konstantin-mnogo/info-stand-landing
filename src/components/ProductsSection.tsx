  ...
  const products: Product[] = [
    {
      ...
      description: 'Помогаем людям быстро находить нужные кабинеты. Хорошие указатели — это меньше вопросов сотрудникам и довольные посетители.',
    ...
    },
    {
      ...
      description: 'Для расписаний, объявлений и официальных документов. Документы защищены, их легко менять.',
    ...
    },
    {
      ...
      description: 'С подсветкой товар выглядит ярче и привлекает больше внимания. Хорошо подходит для витрин и промо-зон.',
    ...
    },
    {
      ...
      description: 'Прозрачный акрил выглядит как стекло, но легче и безопаснее. Стильное решение для офисов.',
    ...
    },
    {
      id: 5,
      title: 'Фотозоны',
      description: 'Создаём яркие фотозоны для мероприятий. Посетители делают фото — ваш логотип в соцсетях.',
    ...
    },
    {
      ...
      description: 'Подвешиваем панно к потолку — стены не сверлим. Легко менять экспозицию без следов.',
    ...
    },
    {
      ...
      description: 'Объёмный декор для стен офисов — 3D-панели, карты, логотипы. Делаем помещение уютнее и тише.',
    ...
    },
    {
      ...
      description: 'Объёмные буквы и логотипы внутри помещений. С подсветкой или без — эффектно смотрится.',
